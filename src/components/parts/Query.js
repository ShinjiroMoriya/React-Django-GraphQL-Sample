export const accountQuery = "id name";

export const authQuery = "status expire account { id name }";

export const loginQuery = "status expire token account { id name }";
...
export const topNewsQuery = "edges { node { pk name activeDate } }";

export const newsQuery =
  "edges { node { pk name content activeDate } } " +
  "pages totalCount perPage currentPage";

export const newsItemQuery = "pk name content activeDate";

export const errorQuery = "field message";
